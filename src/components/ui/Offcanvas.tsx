...
export function Offcanvas({
  ...
  useEffect(() => {
    ...
    // Bloquer le scroll sur html + body : sur certains navigateurs la barre reste sur <html>
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content - scrollable */}
        <div className="scrollbar-thin flex-1 overflow-y-auto p-4 md:p-6">{children}</div>
